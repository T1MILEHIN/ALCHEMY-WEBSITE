...
const StaircaseStep = ({ step, index, totalSteps }: StaircaseStepProps) => {
    ...
    return (
        <div>
            {/* Mobile */}
            <div
                className={`relative flex lg:hidden items-center justify-center transition-all duration-500 hover:scale-105`}
                style={{
                    marginBottom: '2rem',
                }}>
                {/* Step Box */}
            ...
            {/* Desktop */}
            <div
                className={`flex-row-reverse relative hidden lg:flex items-cent transition-all duration-500 hover:scale-105`}
                style={{
                    marginBottom: '1.5rem',
